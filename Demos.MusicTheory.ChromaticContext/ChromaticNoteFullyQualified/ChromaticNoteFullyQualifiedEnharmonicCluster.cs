...
public class ChromaticNoteFullyQualifiedEnharmonicCluster : ChromaticEntity
{
    public ChromaticNoteFullyQualified[] Cluster { get; }

    public ChromaticNoteFullyQualifiedEnharmonicCluster(ChromaticNoteFullyQualified[] enharmonicNotes) : base(GetChromaticContextIndex(enharmonicNotes))
    {
    ...
    private static void CheckEnharmonicNoteCompatibility(ChromaticNoteFullyQualified[] enharmonicNotes)
    {
